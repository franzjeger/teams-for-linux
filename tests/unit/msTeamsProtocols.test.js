...
describe("msTeamsProtocols v1 pattern", () => {
  describe("Valid v1 links - should match", () => {
    const validLinks = [
      ...
      [
        "msteams:/meet/abc123?p=hashedPasscode",
        "short meet link with passcode",
      ],
  ...
  describe("Valid v2 links - should match", () => {
    const validLinks = [
      ...
      [
        ...
        "short meet link (microsoft.com)",
      ],
      [
        "msteams://teams.microsoft.com/meet/abc123?p=hashedPasscode",
        "short meet link with passcode",
      ],
      [
        "msteams://teams.microsoft.com/meet/user@example.com",
        "short meet link with email",
      ],

      // Short meet links on live.com
      ["msteams://teams.live.com/meet/abc123", "short meet link (live.com)"],
      [
        "msteams://teams.live.com/meet/abc123?p=hashedPasscode",
        "short meet link with passcode (live.com)",
      ],

      // Short meet links on cloud.microsoft
      [
        "msteams://teams.cloud.microsoft/meet/abc123",
        "short meet link (cloud.microsoft)",
      ],

      // Standard deep link paths - microsoft.com
      [
        "msteams://teams.microsoft.com/l/meetup-join/19%3ameeting_abc@thread.v2/0",
        "meetup-join",
      ],
      [
        "msteams://teams.microsoft.com/l/channel/19%3Aabc123/General",
        "channel",
      ],
      [
        "msteams://teams.microsoft.com/l/chat/0/0?users=user@example.com",
        "chat",
      ],
      ...
      [
        "msteams://teams.cloud.microsoft/l/meetup-join/19%3ameeting_abc/0",
        "meetup-join (cloud.microsoft)",
      ],
      [
        "msteams://teams.cloud.microsoft/l/chat/0/0?users=user@example.com",
        "chat (cloud.microsoft)",
      ],

      // Standard deep link paths - live.com
      [
        "msteams://teams.live.com/l/meetup-join/19%3ameeting_abc/0",
        "meetup-join (live.com)",
      ],
    ];
...
describe("processArgs URL transformation", () => {
  ...
  it("v1 meetup-join transforms correctly", () => {
    ...
    const expected =
      "https://teams.cloud.microsoft/l/meetup-join/19:meeting_abc/0";
    assert.strictEqual(transformV1(input), expected);
  });
  ...
  it("v2 meetup-join transforms correctly", () => {
    const input =
      "msteams://teams.microsoft.com/l/meetup-join/19:meeting_abc/0";
    const expected =
