...
const testCases = [
  ...
  [
    "https://teams.microsoft.com/l/meetup-join/19%3ameeting_abc123%40thread.v2/0?context=%7B%22Tid%22%3A%22xxx%22%7D",
    true,
    "Standard meetup-join URL",
  ],
  [
    "https://teams.microsoft.com/l/meetup-join/19:meeting_abc@thread.v2/0",
    true,
    "Meetup-join without URL encoding",
  ],

  // Short meet URLs (new format as of Jan 2026)
  ["https://teams.microsoft.com/meet/abc123", true, "Short meet URL"],
  [
    "https://teams.microsoft.com/meet/abc123?p=hashedPasscode",
    true,
    "Short meet URL with passcode",
  ],

  // teams.live.com domain
  ["https://teams.live.com/meet/abc123", true, "teams.live.com meet URL"],
  [
    "https://teams.live.com/l/meetup-join/19:meeting_abc@thread.v2/0",
    true,
    "teams.live.com meetup-join URL",
  ],

  // teams.cloud.microsoft domain (newer format)
  [
    "https://teams.cloud.microsoft/meet/abc123",
    true,
    "teams.cloud.microsoft meet URL",
  ],
  [
    "https://teams.cloud.microsoft/l/meetup-join/19:meeting_abc@thread.v2/0",
    true,
    "teams.cloud.microsoft meetup-join URL",
  ],

  // V2 web app format (meeting path in URL fragment)
  [
    "https://teams.microsoft.com/v2/?meetingjoin=true#/l/meetup-join/19:meeting_abc.v2/0?context=xyz",
    true,
    "V2 meetingjoin URL with fragment",
  ],
  [
    "https://teams.microsoft.com/v2/?meetingjoin=true&anon=true#/l/meetup-join/19:meeting_abc",
    true,
    "V2 meetingjoin URL with extra params",
  ],

  // Channel URLs
  [
    "https://teams.microsoft.com/l/channel/19%3Aabc123%40thread.tacv2/General?groupId=xxx",
    true,
    "Channel URL",
  ],
  ...
  [
    "https://teams.microsoft.com/meetup-join/abc123",
    false,
    "Missing /l/ prefix",
  ],
  [
    "https://teams.microsoft.com/v2/l/meetup-join/abc123",
    false,
    "/v2/l/ path not supported (use v2/?meetingjoin=)",
  ],
  [
...
for (const [url, shouldMatch, description] of testCases) {
  ...
  if (success) {
    ...
    console.log(`  URL: ${url}`);
    console.log(
      `  Expected: ${shouldMatch ? "MATCH" : "NO MATCH"}, Got: ${result ? "MATCH" : "NO MATCH"}`,
    );
  }
}
